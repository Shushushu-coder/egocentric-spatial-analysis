...
## Dual-observer egocentric capture

- Use two (or more) rigidly or wearable cameras looking along a shared path if you intend to compare viewpoints.
...
- Do not publish unredacted street footage, faces, or other identifiers with this repository.
